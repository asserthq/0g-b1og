                ...
                <div class="grid-rows-[auto_1fr] divide-y divide-gray-200 pb-8 dark:divide-gray-700 xl:divide-y-0">
                    <div class="divide-y divide-gray-200 dark:divide-gray-700 xl:col-span-3 xl:row-span-2 xl:pb-0">
                        ...
                        <div class="prose max-w-none pb-8 pt-10 dark:prose-invert">
                            ...
                            <p>See <a href="#upgrade-guide">upgrade guide</a> below if you are migrating from v0 version of
                                the template.</p>
                            <h2 id="theme-colors"><a href="#theme-colors" aria-hidden="true" tabindex="-1"><span
                                        class="icon icon-link"></span></a>Theme colors</h2>
                            <p>You can easily modify the theme color by changing the primary attribute in the tailwind
                                config file:</p>
                            <div class="remark-code-title">tailwind.config.js</div>
                            <div class="relative">
                                <pre><code class="code-highlight language-js"><span class="code-line"><span class="token property literal-property">theme</span><span class="token operator">:</span> <span class="token punctuation">{</span>
                            ...
                            <p>The primary color attribute should be assigned an object with keys from 50, 100, 200 ... 900
                                and the corresponding color code values.</p>
                            <p>Tailwind includes great default color palettes that can be used for theming your own website.
                                Check out <a target="_blank" rel="noopener noreferrer"
                                    href="https://tailwindcss.com/docs/customizing-colors">customizing colors documentation
                                    page</a> for the full range of options.</p>
                            <p>Migrating from v1? You can revert to the previous theme by setting <code>primary</code> to
                                <code>colors.sky</code> (Tailwind 2.2.2 and above, otherwise <code>colors.lightBlue</code>)
                                and changing gray to <code>colors.gray</code>.</p>
                            <p>From v1.1.2+, you can also customize the style of your code blocks easily by modifying the
                                <code>css/prism.css</code> stylesheet. Token classnames are compatible with prismjs so you
                                can copy and adapt token styles from a prismjs stylesheet e.g. <a target="_blank"
                                    rel="noopener noreferrer" href="https://github.com/PrismJS/prism-themes">prism
                                    themes</a>.</p>
                            ...
                            <p>We switched the MDX bundler from <a target="_blank" rel="noopener noreferrer"
                                    href="https://github.com/hashicorp/next-mdx-remote">next-mdx-remote</a> to <a
                                    target="_blank" rel="noopener noreferrer"
                                    href="https://github.com/kentcdodds/mdx-bundler">mdx-bundler</a>. This uses <a
                                    target="_blank" rel="noopener noreferrer" href="https://github.com/wooorm/xdm">xdm</a>
                                under the hood, the latest micromark 3 and remark, rehype libraries.</p>
                            <p><strong>Warning:</strong> If you were using custom remark or rehype libraries, please upgrade
                                to micromark 3 compatible ones. If you are upgrading, please delete
                                <code>node_modules</code> and <code>package-lock.json</code> to avoid having past
                                dependencies related issues.</p>
                            <p><a target="_blank" rel="noopener noreferrer" href="https://github.com/wooorm/xdm">xdm</a>
                                contains multiple improvements over <a target="_blank" rel="noopener noreferrer"
                                    href="https://github.com/mdx-js/mdx">@mdx-js/mdx</a>, the compiler used internally by
                                next-mdx-remote, but there might be some breaking behaviour changes. Please check your
                                markdown output to verify.</p>
                            <p>Some new possibilities include loading components directly in the mdx file using the import
                                syntax and including js code which could be compiled and bundled at the build step.</p>
                            <p>For example, the following jsx snippet can be used directly in an MDX file to render the page
                                title component:</p>
                            <div class="relative">
                                <pre><code class="code-highlight language-jsx"><span class="code-line"><span class="token comment">// Or import PageTitle from './components/PageTitle.js' if you are using js</span>
                            ...
                            <p>The default configuration resolves all components relative to the <code>components</code>
                                directory.</p>
                            <p><strong>Note</strong>: Components which require external image loaders also require
                                additional esbuild configuration. Components which are dependent on global application state
                                on lifecycle like the Nextjs <code>Link</code> component would also not work with this setup
                                as each mdx file is built independently. For such cases, it is better to use component
                                substitution.</p>
                            <h2 id="table-of-contents-component"><a href="#table-of-contents-component"
                                    aria-hidden="true" tabindex="-1"><span class="icon icon-link"></span></a>Table of
                                contents component</h2>
                            <p>Inspired by <a target="_blank" rel="noopener noreferrer"
                                    href="https://docusaurus.io/docs/next/markdown-features/inline-toc">Docusaurus</a> and
                                Gatsby's <a target="_blank" rel="noopener noreferrer"
                                    href="https://www.gatsbyjs.com/plugins/gatsby-remark-table-of-contents/">gatsby-remark-table-of-contents</a>,
                                the <code>toc</code> variable containing all the top level headings of the document is
                                passed to the MDX file and can be styled accordingly. To make generating a table of contents
                                (TOC) simple, you can use the existing <code>TOCInline</code> component.</p>
                            ...
                            <p>You can customise the headings that are displayed by configuring the <code>fromHeading</code>
                                and <code>toHeading</code> props, or exclude particular headings by passing a string or a
                                string array to the <code>exclude</code> prop. By default, all headings that are of depth 3
                                or smaller are indented. This can be configured by changing the <code>indentDepth</code>
                                property. A <code>asDisclosure</code> prop can be used to render the TOC within an
                                expandable disclosure element.</p>
                            ...
                            <details open="">
                                ...
                                <div class="ml-6">
                                    <ul>
                                        ...
                                        <li class="false"><a href="#theme-colors">Theme colors</a></li>
                                        <li class="false"><a href="#xdm-mdx-compiler">Xdm MDX compiler</a></li>
                                        <li class="false"><a href="#table-of-contents-component">Table of contents
                                                component</a></li>
                                        <li class="false"><a href="#layouts">Layouts</a></li>
                                        <li class="ml-6"><a href="#adding-new-templates">Adding new templates</a></li>
                                        <li class="ml-6"><a href="#configuring-a-blog-post-frontmatter">Configuring a
                                                blog post frontmatter</a></li>
                                        <li class="ml-6"><a href="#extend">Extend</a></li>
                                        <li class="false"><a href="#analytics">Analytics</a></li>
                                        <li class="false"><a href="#blog-comments-system">Blog comments system</a></li>
                                        <li class="false"><a href="#multiple-authors">Multiple authors</a></li>
                                        <li class="ml-6"><a href="#multiple-authors-in-blog-post">Multiple authors in
                                                blog post</a></li>
                                        <li class="false"><a href="#copy-button-for-code-blocks">Copy button for code
                                                blocks</a></li>
                                        <li class="false"><a href="#line-highlighting-and-line-numbers">Line highlighting
                                                and line numbers</a></li>
                                        <li class="false"><a href="#newletter-component-v113">Newletter component
                                                (v1.1.3)</a></li>
                                        <li class="false"><a href="#bibliography-and-citations-v121">Bibliography and
                                                Citations (v1.2.1)</a></li>
                                        <li class="false"><a href="#self-hosted-font-v150">Self-hosted font (v1.5.0)</a>
                                        </li>
                                        <li class="false"><a href="#upgrade-guide">Upgrade guide</a></li>
                                    </ul>
                                </div>
                            ...
                            <p>You can map mdx blog content to layout components by configuring the frontmatter field. For
                                example, this post is written with the new <code>PostSimple</code> layout!</p>
                            <h3 id="adding-new-templates"><a href="#adding-new-templates" aria-hidden="true"
                                    tabindex="-1"><span class="icon icon-link"></span></a>Adding new templates</h3>
                            <p>layout templates are stored in the <code>./layouts</code> folder. You can add your React
                                components that you want to map to markdown content in this folder. The component file name
                                must match that specified in the markdown frontmatter <code>layout</code> field.</p>
                            <p>The only required field is <code>children</code> which contains the rendered MDX content,
                                though you would probably want to pass in the frontMatter contents and render it in the
                                template.</p>
                            <p>You can configure the template to take in other fields - see <code>PostLayout</code>
                                component for an example.</p>
                            ...
                            <h3 id="configuring-a-blog-post-frontmatter"><a href="#configuring-a-blog-post-frontmatter"
                                    aria-hidden="true" tabindex="-1"><span class="icon icon-link"></span></a>Configuring
                                a blog post frontmatter</h3>
                            <p>Use the <code>layout</code> frontmatter field to specify the template you want to map the
                                markdown post to. Here's how the frontmatter of this post looks like:</p>
                            <div class="relative">
                                <pre><code class="code-highlight language-js"><span class="code-line"><span class="token operator">--</span><span class="token operator">-</span>
                            ...
                            <p>You can configure the default layout in the respective page section by modifying the
                                <code>DEFAULT_LAYOUT</code> variable. The <code>DEFAULT_LAYOUT</code> for blog posts page is
                                set to <code>PostLayout</code>.</p>
                            ...
                            <p>Use the <code>MDXLayoutRenderer</code> component on a page where you want to accept a layout
                                name to map to the desired layout. You need to pass the layout name from the layout folder
                                (it has to be an exact match).</p>
                            ...
                            <p>The template now supports <a target="_blank" rel="noopener noreferrer"
                                    href="https://plausible.io/">plausible</a>, <a target="_blank"
                                    rel="noopener noreferrer" href="https://simpleanalytics.com/">simple analytics</a> and
                                google analytics. Configure <code>siteMetadata.js</code> with the settings that correspond
                                with the desired analytics provider.</p>
                            <div class="relative">
                                <pre><code class="code-highlight language-js"><span class="code-line"><span class="token property literal-property">analytics</span><span class="token operator">:</span> <span class="token punctuation">{</span>
                            ...
                            <p>Custom events are also supported. You can import the <code>logEvent</code> function from
                                <code>@components/analytics/[ANALYTICS-PROVIDER]</code> file and call it when triggering
                                certain events of interest. <em>Note</em>: Additional configuration might be required
                                depending on the analytics provider, please check their official documentation for more
                                information.</p>
                            <h2 id="blog-comments-system"><a href="#blog-comments-system" aria-hidden="true"
                                    tabindex="-1"><span class="icon icon-link"></span></a>Blog comments system</h2>
                            <p>We have also added support for <a target="_blank" rel="noopener noreferrer"
                                    ...
                                    href="https://github.com/utterance/utterances">utterances</a> or disqus. To enable,
                                simply configure <code>siteMetadata.js</code> comments property with the desired provider
                                and settings as specified in the config file.</p>
                            <div class="relative">
                                <pre><code class="code-highlight language-js"><span class="code-line"><span class="token property literal-property">comment</span><span class="token operator">:</span> <span class="token punctuation">{</span>
                            ...
                            <h2 id="multiple-authors"><a href="#multiple-authors" aria-hidden="true"
                                    tabindex="-1"><span class="icon icon-link"></span></a>Multiple authors</h2>
                            <p>Information on authors is now split from <code>siteMetadata.js</code> and stored in its own
                                ...
                                required and the file name will be used as the reference to the author.</p>
                            ...
                            <p>You can use this information in multiple places across the template. For example in the about
                                section of the page, we grab the default author information with this line of code:</p>
                            <div class="relative">
                            ...
                            <h3 id="multiple-authors-in-blog-post"><a href="#multiple-authors-in-blog-post"
                                    aria-hidden="true" tabindex="-1"><span class="icon icon-link"></span></a>Multiple
                                authors in blog post</h3>
                            <p>The frontmatter of a blog post accepts an optional <code>authors</code> array field. If no
                                field is specified, it is assumed that the default author is used. Simply pass in an array
                                of authors to render multiple authors associated with a post.</p>
                            <p>For example, the following frontmatter will display the authors given by
                                <code>data/authors/default.md</code> and <code>data/authors/sparrowhawk.md</code></p>
                            <div class="relative">
                            ...
                            <p>A demo of a multiple authors post is shown in <a
                                    href="/blog/introducing-tailwind-nextjs-starter-blog">Introducing Tailwind Nextjs
                                    Starter Blog post</a>.</p>
                            <h2 id="copy-button-for-code-blocks"><a href="#copy-button-for-code-blocks"
                                    aria-hidden="true" tabindex="-1"><span class="icon icon-link"></span></a>Copy button
                                for code blocks</h2>
                            <p>Hover over a code block and you will notice a GitHub-inspired copy button! You can modify
                                ...
                                <code>MDXComponents</code> and modifies all <code>&lt;pre&gt;</code> blocks.</p>
                            <h2 id="line-highlighting-and-line-numbers"><a href="#line-highlighting-and-line-numbers"
                                    aria-hidden="true" tabindex="-1"><span class="icon icon-link"></span></a>Line
                                highlighting and line numbers</h2>
                            ...
                            <p>To modify the styles, change the following class selectors in the <code>prism.css</code>
                                file:</p>
                            <div class="relative">
                            ...
                            <h2 id="newletter-component-v113"><a href="#newletter-component-v113" aria-hidden="true"
                                    tabindex="-1"><span class="icon icon-link"></span></a>Newletter component (v1.1.3)
                            </h2>
                            ...
                            <ul>
                                <li><a target="_blank" rel="noopener noreferrer"
                                        href="https://mailchimp.com/">Mailchimp</a></li>
                                <li><a target="_blank" rel="noopener noreferrer"
                                        href="https://buttondown.email/">Buttondown</a></li>
                                <li><a target="_blank" rel="noopener noreferrer"
                                        href="https://convertkit.com/">Convertkit</a></li>
                            </ul>
                            <p>To use it, specify the provider which you are using in the config file and add the necessary
                                environment variables to the <code>.env</code> file. For more information on the required
                                variables, check out <code>.env.sample.</code></p>
                            <p>Two components are exported, a default <code>NewsletterForm</code> and a
                                <code>BlogNewsletterForm</code> component, which is also passed in as an MDX component and
                                can be used in a blog post:</p>
                            <div class="relative">
                            ...
                            <div class="flex items-center justify-center">
                                <div class="bg-gray-100 p-6 dark:bg-gray-800 sm:px-14 sm:py-8">
                                    <div>
                                        <div class="pb-1 text-lg font-semibold text-gray-800 dark:text-gray-100">Like what
                                            you are reading?</div>
                                        <form class="flex flex-col sm:flex-row">
                                            <div><label for="email-input"><span class="sr-only">Email
                                                        address</span><input autocomplete="email"
                                                        class="focus:ring-primary-600 w-72 rounded-md px-4 focus:border-transparent focus:outline-none focus:ring-2 dark:bg-black"
                                                        id="email-input" placeholder="Enter your email" required=""
                                                        type="email" name="email"></label></div>
                            ...
                            <p>The component relies on nextjs's <a target="_blank" rel="noopener noreferrer"
                                ...
                                server-side instance of nextjs to be setup and is not compatible with a 100% static site
                                export. Users should either self-host or use a compatible platform like Vercel or Netlify
                                which supports this functionality.</p>
                            <p>A static site compatible alternative is to substitute the route in the newsletter component
                                with a form API endpoint provider.</p>
                            <h2 id="bibliography-and-citations-v121"><a href="#bibliography-and-citations-v121"
                                    aria-hidden="true" tabindex="-1"><span
                                        class="icon icon-link"></span></a>Bibliography and Citations (v1.2.1)</h2>
                            <p><code>rehype-citation</code> plugin is added to the xdm processing pipeline in v1.2.1. This
                                allows you to easily format citations and insert bibliography from an existing bibtex or
                                CSL-json file.</p>
                            ...
                            <p>Standard citation <span id="citation--nash1950--1">(Nash, 1950)</span><br>In-text citations
                                e.g. <span id="citation--nash1951--2">Nash (1951)</span><br>Multiple citations <span
                                    id="citation--nash1950--nash1951--3">(see Nash, 1950, 1951, p. 50)</span></p>
                            <p><strong>References:</strong></p>
                            <div class="csl-bib-body references" id="refs">
                                <div class="csl-entry" id="bib-nash1950">Nash, J. (1950). Equilibrium points in n-person
                                    games. <i>Proceedings of the National Academy of Sciences</i>, <i>36</i>(1), 48–49.
                                </div>
                                <div class="csl-entry" id="bib-nash1951">Nash, J. (1951). Non-cooperative games.
                                    <i>Annals of Mathematics</i>, 286–295.</div>
                            </div>
                            <p>A bibliography will be inserted at the end of the document, but this can be overwritten by
                                specifying a <code>[^Ref]</code> tag at the intended location. The plugin uses APA citation
                                formation, but also supports the following CSLs, 'apa', 'vancouver', 'harvard1', 'chicago',
                                'mla', or a path to a user-specified CSL file.</p>
                            <p>See <a target="_blank" rel="noopener noreferrer"
                                    href="https://github.com/timlrx/rehype-citation">rehype-citation readme</a> for more
                                information on the configuration options.</p>
                            <h2 id="self-hosted-font-v150"><a href="#self-hosted-font-v150" aria-hidden="true"
                                    tabindex="-1"><span class="icon icon-link"></span></a>Self-hosted font (v1.5.0)
                            </h2>
                            <p>Google font has been replaced with self-hosted font from <a target="_blank"
                                    rel="noopener noreferrer" href="https://fontsource.org/">Fontsource</a>. This gives
                                the following <a target="_blank" rel="noopener noreferrer"
                                    href="https://fontsource.org/docs/introduction">advantages</a>:</p>
                            <blockquote>
                                <p>Self-hosting brings significant performance gains as loading fonts from hosted services,
                                    such as Google Fonts, lead to an extra (render blocking) network request. To provide
                                    perspective, for simple websites it has been seen to double visual load times.</p>
                                <p>Fonts remain version locked. Google often pushes updates to their fonts without notice,
                                    which may interfere with your live production projects. Manage your fonts like any other
                                    NPM dependency.</p>
                                <p>Commit to privacy. Google does track the usage of their fonts and for those who are
                                    extremely privacy concerned, self-hosting is an alternative.</p>
                            </blockquote>
                            ...
                            <ol>
                                <li>Install the preferred <a target="_blank" rel="noopener noreferrer"
                                        href="https://fontsource.org/fonts">font</a> - <code>npm install -save
                                        @fontsource/&lt;font-name&gt;</code></li>
                                <li>Update the import at <code>pages/_app.js</code>- <code>import
                                        '@fontsource/&lt;font-name&gt;.css'</code></li>
                            ...
                            <p>There are significant portions of the code that has been changed from v0 to v1 including
                                support for layouts and a new mdx engine.</p>
                            <p>There's also no real reason to change if the previous one serves your needs and it might be
                                easier to copy the component changes you are interested in to your existing blog rather than
                                migrating everything over.</p>
                            <p>Nonetheless, if you want to do so and have not changed much of the template, you could clone
                                the new version and copy over the blog post over to the new template.</p>
                            ...
                            <p>You can see an example of such a migration in this <a target="_blank"
                                    rel="noopener noreferrer"
                                    href="https://github.com/timlrx/timlrx.com/commit/bba1c185384fd6d5cdaac15abf802fdcff027286">commit</a>
                                for my personal blog.</p>
                            <p>v1 also uses <code>feed.xml</code> rather than <code>index.xml</code>, to avoid some build
                                issues with Vercel. If you are migrating you should add a redirect to
                                <code>next.config.js</code> like so:</p>
                            <div class="relative">
