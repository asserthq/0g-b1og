            ...
            <div
                ...
                <div class="px-6 py-4">
                    <a href="{{ route('home.blog') }}">
                        <h3 class="font-bold @if($category_filter == null) text-gray-800 dark:text-gray-200 uppercase @else text-gray-500 dark:text-gray-400 @endif hover:text-primary-600 dark:hover:text-primary-400">
                            All Posts
                        </h3>
                    </a>
                    <ul>
                        ...
                        @foreach ($categories as $category)
                            <li class="my-3">
                                <a href="{{ route('home.blog.category', $category->slug) }}"
                                    class="px-3 py-2 text-sm font-medium @if($category_filter != null && $category_filter->id == $category->id) text-gray-900 dark:text-gray-100 uppercase @else text-gray-600 dark:text-gray-300 @endif hover:text-primary-500 dark:hover:text-primary-500"
